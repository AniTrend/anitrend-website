export const dashboardCopy = {
  hero: {
    title: 'Your AniTrend Hub',
    description:
      'Jump back into the anime you care about, explore curated filters, and grab AI-powered picks in one place.',
    cta: {
      aiRecommendations: 'Get AI Recommendations',
    },
  },
  shortcuts: {
    title: 'Discover shortcuts',
    badge: 'URL presets',
    cta: 'Open in Discover',
    items: [
      {
        title: 'Top Airing',
  ...
  upcoming: {
    ...
    itemStatus: 'Upcoming',
    emptyState:
      'Unable to load upcoming picks right now. Try again shortly or jump into Discover.',
  },
} as const;
